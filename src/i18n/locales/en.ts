export default {
  ...
  phoneView: {
    ...
    callTo: 'Calling',
    redial: 'Redial',
    dnd: 'Dont not Disturb',
    dndOn: 'Dont not Disturb On',
    // voicemail: 'VoiceMail: {{new}}/{{old}}',
    mic: 'MIC Configuration',
    micOn: 'MIC Configuration',
    mute: 'MUTE',
    unmute: 'UNMUTE',
    autoAnswer: ' Auto Answer Calls Off',
    autoAnswerOn: 'Auto Answer Calls On',
    hold: 'HOLD',
    unhold: 'UNHOLD', 
  ...
  activityLogs: {
    ...
    autoAnswerActivated: 'Auto Answer Calls On',
    autoAnswerDeactivated: ' Auto Answer Calls Off',

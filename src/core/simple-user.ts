...
import type { InviterOptions } from "sip.js/lib/api/inviter-options";
...
import { SessionManager } from "sip.js/lib/platform/web/session-manager/session-manager";
import type { SessionManagerOptions } from "sip.js/lib/platform/web/session-manager/session-manager-options";
import type { SimpleUserDelegate } from "sip.js/lib/platform/web/simple-user/simple-user-delegate";
import type { SimpleUserOptions } from "sip.js/lib/platform/web/simple-user/simple-user-options";
